...
- REST API design and third-party system integrations
- SQL query optimization and database performance
- Test automation and CI/CD pipelines
- AI-assisted development workflows (LLMs, Claude Code, GitHub Copilot)
- Monolith-to-microservices migration and cloud infrastructure

## Education

**Bachelor's Degree, Internet Systems** — University of Passo Fundo, Brazil (2014–2018)
